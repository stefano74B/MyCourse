...
// creiamo un Tag Helper per sanitizzare Cross-Site Scripting (XSS)
// e quindi prevenire i malintenzionati dove abbiamo usato Html.Raw() in Detail.cshtml
// che vogliono inserire script Javascript pericolosi
// anche se sarebbe meglio sanitizzare e validare nell'input del form 
...
namespace MyCourse.Customizations.TagHelpers
{
    ...
    public class HtmlSanitizeTagHelper : TagHelper
    {
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            // qui sanitizziamo utilizzando il pacchetto NuGet HtmlSanitizer
