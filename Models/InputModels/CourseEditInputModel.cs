...
namespace MyCourse.Models.InputModels
{
    public class CourseEditInputModel : IValidatableObject
    {
        ...
        // facendo implementare l'interfaccia IValidatableObject, possiamo effettuare la validation in questo modo
        // altrimenti possiamo anche creare una data annotation personalizzata in un'altra classe
